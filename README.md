...
The official implementation of the paper **"A Cross-disease Knowledge Transfer Framework for Small-sample Omics Analysis with GNNs"** (accepted by BIBM 2025 workshops).
